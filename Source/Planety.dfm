object Planety_Form: TPlanety_Form
  Left = 0
  Top = 0
  Caption = 'Planety z Eris Kallisti Dyskordia'
  ClientHeight = 662
  ClientWidth = 634
  Color = clBtnFace
  ...
  object PageControl1: TPageControl
    ...
    object Opcje_TabSheet: TTabSheet
      ...
      DesignSize = (
        192
        634)
      object Mapa_Etykieta_Label: TLabel
        Left = 5
        Top = 5
        Width = 26
        Height = 13
        Hint = '<Karte.>'#13#10#13#10'<Map.>'
        Caption = 'Mapa'
        ParentShowHint = False
        ShowHint = True
      end
      object Gra_Prędkość_Etykieta_Label: TLabel
        Left = 5
        Top = 175
        Width = 62
        Height = 13
        Hint = '<Spielgeschwindigkeit.>'#13#10#13#10'<Game speed.>'
        Caption = 'Pr'#281'dko'#347#263' gry'
        ParentShowHint = False
        ShowHint = True
      end
      object Rakiety_Ilość_Procent_Wysłanie_Etykieta_Label: TLabel
        Left = 5
        Top = 230
        Width = 74
        Height = 26
        Hint = 
          'Jaki procent rakiet wys'#322'a'#263' za jednym razem z planety.'#13#10#13#10'<Wie vi' +
          'el Prozent der Raketen sollen auf einmal vom Planeten gesendet w' +
          'erden.>'#13#10#13#10'<What percentage of rockets to send from the planet a' +
          't once.>'
        Caption = '% wysy'#322'anych rakiet'
        ParentShowHint = False
        ShowHint = True
        WordWrap = True
      end
      object SI_Decyduj__Cykl_Sekundy_Etykieta_Label: TLabel
        Left = 5
        Top = 325
        Width = 31
        Height = 13
        Hint = 
          'Co ile sekund nast'#281'puje standardowe przeliczenie decyzji SI.'#13#10#13#10 +
          '<Alle wie viele Sekunden gibt es eine Standard-KI-Entscheidungs-' +
          'Neuberechnung.>'#13#10#13#10'<Every how many seconds the AI decision is re' +
          'calculated as standard.>'
        Caption = 'SI cykl'
        ParentShowHint = False
        ShowHint = True
      end
      object Mapy_Losowe_Etykieta_Label: TLabel
        Left = 5
        Top = 385
        Width = 52
        Height = 13
        Hint = 
          'Rozegranych map / wszystkich map.'#13#10#13#10'<Gespielte Karten / alle Ka' +
          'rten.>'#13#10#13#10'<Maps played / all maps.>'
        Caption = '<?> / <?>'
        ParentShowHint = False
        ShowHint = True
      end
      object Mapa_ComboBox: TComboBox
        Left = 5
        Top = 25
        Width = 180
        Height = 22
        ...
        DropDownCount = 50
        TabOrder = 0
        OnChange = Mapa_ComboBoxChange
      end
      object Start_Stop_Button: TButton
        Left = 5
        Top = 65
        Width = 50
        Height = 25
      ...
      object Gra_Prędkość_SpinEdit: TSpinEdit
        Left = 80
        Top = 175
        Width = 60
        Height = 22
      ...
      object Rakiety_Ilość_Procent_Wysłanie_SpinEdit: TSpinEdit
        Left = 80
        Top = 230
        Width = 60
        Height = 22
      ...
      object Następna_Misja_Button: TButton
        ...
        ShowHint = True
        TabOrder = 4
        OnClick = Następna_Misja_ButtonClick
      end
      object Statystyki_Button: TButton
        Left = 115
        Top = 95
        Width = 50
        Height = 25
        Hint = 'Statystyki [I].'#13#10#13#10'<Statistiken.>'#13#10#13#10'<Statistics.>'
        Caption = '1, 2, 3'
        ParentShowHint = False
        ShowHint = True
        TabOrder = 6
        OnClick = Statystyki_ButtonClick
      end
      object Planety_Opisy_CheckBox: TCheckBox
        Left = 5
        Top = 140
        Width = 85
        Height = 17
        Hint = 
          'Wsp'#243#322'czynnik przej'#281'cia planety / wsp'#243#322'czynnik zaj'#281'cia orbity pla' +
          'nety przez rakiety'#13#10'(gdy osi'#261'gnie 100 rakiety nie b'#281'd'#261' tworzone ' +
          'na planecie).'#13#10#13#10'<Planetenerfassungsrate / Rate der Planetenerfa' +
          'ssung durch Raketen'#13#10'(wenn es 100 erreicht, werden die Raketen n' +
          'icht auf dem Planeten gebaut).>'#13#10#13#10'<Planet acquisition rate / ra' +
          'te of planet acquisition by rockets'#13#10'(when it reaches 100, the r' +
          'ockets will not be built on the planet).>| wsp'#243#322'czynnik zaj'#281'cia ' +
          'orbity planety przez rakiety (gdy osi'#261'gnie 100 rakiety nie b'#281'd'#261' ' +
          'tworzone na planecie).'
        Caption = 'Opisy planet'
        ParentShowHint = False
        ShowHint = True
        TabOrder = 7
        OnClick = Planety_Opisy_CheckBoxClick
      end
      object Ruch_Ostatni_Ponów_Button: TButton
        Left = 60
        Top = 95
        Width = 50
        Height = 25
        Hint = 
          'Pon'#243'w ostatni ruch [F1].'#13#10#13#10'<Letzten Zug wiederholen.>'#13#10#13#10'<Redo ' +
          'last move.>'
        Caption = 'Pon'#243'w'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        ...
        ShowHint = True
        TabOrder = 5
        OnClick = Ruch_Ostatni_Ponów_ButtonClick
      end
      object Planety_Opisy__Dodatkowe_Informacje_CheckBox: TCheckBox
        Left = 95
        Top = 140
        Width = 85
        Height = 17
        Hint = 
          'Dodatkowe informacje o planecie:'#13#10'id_planeta; id_grupa planety; ' +
          'pojemno'#347#263' planety; szybko'#347#263' przyrostu planety.'#13#10#13#10'<Zus'#228'tzliche I' +
          'nformationen '#252'ber den Planeten: id Planet; Planetengruppen-ID; P' +
          'lanetenkapazit'#228't; die Geschwindigkeit des Wachstums des Planeten' +
          '.>'#13#10#13#10'<Additional information about the planet: id planet; plane' +
          't group id; planet capacity; the speed of the planet'#39's growth.>'
        Caption = 'dodatkowe i.'
        Enabled = False
        ParentShowHint = False
        ShowHint = True
      ...
      object Zajętość_Orbity_Wizualizuj_CheckBox: TCheckBox
        Left = 5
        Top = 205
        Width = 150
        Height = 17
        Hint = 
          'Wizualizuj zaj'#281'to'#347#263' orbity planety przez rakiety.'#13#10#13#10'<Visualisie' +
          'ren Sie die Besetzung der Umlaufbahn des Planeten durch Raketen.' +
          '>'#13#10#13#10'<Visualize the occupancy of the planet'#39's orbit by rockets.>'
        Caption = 'Wizualizuj zaj'#281'to'#347#263' orbity'
        ParentShowHint = False
        ShowHint = True
        TabOrder = 10
      end
      object SI_Normalne_Button: TButton
        Left = 5
        Top = 285
        Width = 75
        Height = 25
        Hint = '<Normale KI.>'#13#10#13#10'<Normal AI.>'
        Caption = 'SI normalne'
        ParentShowHint = False
        ShowHint = True
        TabOrder = 12
        OnClick = SI_Trudność_ButtonClick
      end
      object SI_Trudniejsze_Button: TButton
        Left = 91
        Top = 285
        Width = 75
        Height = 25
        Hint = '<KI schwieriger.>'#13#10#13#10'<AI more difficult.>'
        Caption = 'SI trudniejsze'
        ParentShowHint = False
        ShowHint = True
        TabOrder = 13
        OnClick = SI_Trudność_ButtonClick
      end
      object SI_Decyduj__Cykl_Sekundy_SpinEdit: TSpinEdit
        Left = 55
        Top = 325
        Width = 60
        Height = 22
      ...
      object Grupa_Fann_Decyduje_GroupBox: TGroupBox
        Left = 5
        Top = 405
        Width = 180
        Height = 225
        Anchors = [akLeft, akTop, akRight, akBottom]
        Caption = 'Grupa fann decyduje'
        TabOrder = 17
        DesignSize = (
          180
          225)
        object Grupa_Fann_Decyduje_CheckListBox: TCheckListBox
          Left = 5
          Top = 15
          Width = 145
          Height = 205
          Hint = 
            'Decyzje zaznaczonych grup podejmuje fann a nie algorytm.'#13#10#13#10'<Die' +
            ' Entscheidungen der ausgew'#228'hlten Gruppen werden vom FANN getroff' +
            'en, nicht vom Algorithmus.>'#13#10#13#10'<The decisions of the selected gr' +
            'oups are made by the fan, not by the algorithm.>'
          Anchors = [akLeft, akTop, akRight, akBottom]
          ItemHeight = 13
          ParentShowHint = False
          ShowHint = True
        ...
        object Grupa_Fann_Decyduje__Zaznacz_Wszystko_Button: TButton
          Left = 155
          Top = 20
          Width = 20
          Height = 20
          Hint = 'Zaznacz wszystko.'#13#10#13#10'<W'#228'hlen Sie Alle.>'#13#10#13#10'<Select all.>'
          Anchors = [akTop, akRight]
          Caption = '+'
          ParentShowHint = False
          ShowHint = True
          TabOrder = 1
          OnClick = Grupa_Fann_Decyduje__Zaznacz_ButtonClick
        end
        object Grupa_Fann_Decyduje__Odznacz_Wszystko_Button: TButton
          Left = 155
          Top = 45
          Width = 20
          Height = 20
          Hint = 'Odznacz wszystko.'#13#10#13#10'<Alle abw'#228'hlen.>'#13#10#13#10'<Deselect all.>'
          Anchors = [akTop, akRight]
          Caption = '-'
          ParentShowHint = False
          ShowHint = True
        ...
        object Grupa_Fann_Decyduje__Odwróć_Zaznaczenie_Button: TButton
          Left = 155
          Top = 70
          Width = 20
          Height = 20
          Hint = 
            'Odwr'#243#263' zaznaczenie.'#13#10#13#10'<Auswahl umkehren.>'#13#10#13#10'<Invert Selection.' +
            '>'
          Anchors = [akTop, akRight]
          Caption = '/'
          ParentShowHint = False
        ...
        object Grupa_Fann_Decyduje__Algorytm_Tylko_RadioButton: TRadioButton
          Left = 155
          Top = 120
          Width = 113
          Height = 17
          Hint = 
            'Dla wszystkich grupy ustaw aby decyzje by'#322'y podejmowane przez al' +
            'gorytm.'#13#10#13#10'<Legen Sie f'#252'r alle Gruppen die vom Algorithmus zu tr' +
            'effenden Entscheidungen fest.>'#13#10#13#10'<For all groups, set the decis' +
            'ions to be made by the algorithm.>'
          Anchors = [akTop, akRight]
          Caption = 'A'
          Checked = True
          ParentShowHint = False
        ...
        object Grupa_Fann_Decyduje__Fann_Tylko_RadioButton: TRadioButton
          Left = 155
          Top = 145
          Width = 113
          Height = 17
          Hint = 
            'Dla wszystkich grupy ustaw aby decyzje by'#322'y podejmowane przez fa' +
            'nn.'#13#10#13#10'<Legen Sie f'#252'r alle Gruppen Entscheidungen fest, die vom ' +
            'FANN zu treffen sind.>'#13#10#13#10'<For all groups, set decisions to be m' +
            'ade by the FANN.>'
          Anchors = [akTop, akRight]
          Caption = 'F'
          Enabled = False
        ...
        object Grupa_Fann_Decyduje__Losuj_RadioButton: TRadioButton
          Left = 155
          Top = 170
          Width = 113
          Height = 17
          Hint = 
            'Losowo wybieraj grupy, dla kt'#243'rych decyzje podejmuje fann.'#13#10#13#10'<W' +
            #228'hlen Sie zuf'#228'llig Gruppen aus, f'#252'r die die Entscheidungen von d' +
            'en FANN getroffen werden.>'#13#10#13#10'<Randomly select groups for which ' +
            'the decisions are made by the FANN.>'
          Anchors = [akTop, akRight]
          Caption = 'L'
          Enabled = False
          ParentShowHint = False
      ...
      object Mapa_Wybieraj_Losowo_CheckBox: TCheckBox
        Left = 5
        Top = 360
        Width = 90
        Height = 17
        Hint = 
          'Podczas przechodzenia do nast'#281'pnej misji wybieraj map'#281' losowo.'#13#10 +
          #13#10'<Wenn Sie mit der n'#228'chsten Mission fortfahren, w'#228'hlen Sie die ' +
          'Karte zuf'#228'llig aus.>'#13#10#13#10'<When proceeding to the next mission, se' +
          'lect the map randomly.>'
        Caption = 'Mapa losowo'
        ParentShowHint = False
        ShowHint = True
        TabOrder = 15
      end
      object Mapa_Losuj_BitBtn: TBitBtn
        Left = 100
        Top = 355
        Width = 75
        Height = 25
        Hint = 'Wylosuj map'#281'.'#13#10#13#10'<Karte zeichnen.>'#13#10#13#10'<Draw a map.>'
        Caption = 'Mapa los.'
        Glyph.Data = {
          DE010000424DDE01000000000000760000002800000024000000120000000100
          0400000000006801000000000000000000001000000000000000000000000000
        ...
        ShowHint = True
        TabOrder = 16
        OnClick = Mapa_Losuj_BitBtnClick
      end
    end
    object O_Programie_TabSheet: TTabSheet
      ...
      object O_Programie_Label: TLabel
        ...
        Align = alTop
        Caption = 
          'Planety z Eris Kallisti Dyskordia'#13#10'wydanie 2.0.0.0'#13#10'wersja 2024.' +
          '01.08.'#13#10#13#10'MIT License'#13#10#13#10'Copyright (c) 2021 Jacek Mulawka'#13#10#13#10'j.m' +
          'ulawka@interia.pl'#13#10#13#10'https://github.com/jacek-mulawka'#13#10#13#10#13#10#13#10'Pro' +
          'gram jest darmowy, udost'#281'pniony w postaci takiej jakiej jest wra' +
          'z ze wszystkimi b'#322#281'dami. U'#380'ytkownik zyskuje dost'#281'p do programu, ' +
          'u'#380'ywa programu na w'#322'asne ryzyko i ponosi wy'#322#261'czn'#261' odpowiedzialno' +
          #347#263' za wszelkie szkody (w'#322'asne i niew'#322'asne) materialne i niemater' +
          'ialne oraz utrat'#281' danych w zwi'#261'zku z u'#380'ywaniem programu.'
        WordWrap = True
        ExplicitWidth = 191
      end
    ...
    object SI_TabSheet: TTabSheet
      ...
      object SI_Góra_Panel: TPanel
        ...
        Align = alTop
        TabOrder = 0
        object SI_Loguj_CheckBox: TCheckBox
          Left = 5
          Top = 5
          Width = 70
          Height = 17
          Hint = 
            'Wy'#347'wietlaj wyliczenia SI.'#13#10#13#10'<KI-Aufz'#228'hlungen anzeigen.>'#13#10#13#10'<Dis' +
            'play AI enumerations.>'
          Caption = 'SI loguj'
          ParentShowHint = False
          ShowHint = True
          TabOrder = 0
        end
        object Decyzje_Gracza_Zapamiętuj_CheckBox: TCheckBox
          Left = 5
          Top = 35
          Width = 150
          Height = 17
          Hint = 
            '<Erinnere dich an die Entscheidungen des Spielers.>'#13#10#13#10'<Remember' +
            ' the player'#39's decisions.>'
          Caption = 'Zapami'#281'tuj decyzje gracza'
          ParentShowHint = False
          ShowHint = True
          TabOrder = 1
        end
        object Decyzje_Gracza_Zapisz_Button: TButton
          Left = 95
          Top = 5
          Width = 85
          Height = 25
          Hint = 
            'Zapisz zapami'#281'tane decyzje gracza do pliku w podkatalogu '#39'Decyzj' +
            'e gracza'#39'.'#13#10#13#10'<Speichern Sie gespeicherte Spielerentscheidungen ' +
            'in einer Datei im Unterverzeichnis '#39'Decyzje gracza'#39'.>'#13#10#13#10'<Save r' +
            'emembered player decisions to a file in the '#39'Decyzje gracza'#39' sub' +
            'directory.>'
          Caption = 'Decyzje zapisz'
          ParentShowHint = False
          ShowHint = True
          TabOrder = 2
          OnClick = Decyzje_Gracza_Zapisz_ButtonClick
        end
      end
      object Fann_Nauka_ProgressBar: TProgressBar
        Left = 175
        Top = 335
        Width = 17
        Height = 299
      ...
      object FANN__Opcje_Dodatkowe_GroupBox: TGroupBox
        Left = 0
        Top = 60
        Width = 192
        Height = 275
        Hint = '<FANN zus'#228'tzliche Optionen.>'#13#10#13#10'<FANN additional options.>'
        Align = alTop
        Caption = 'Fann opcje dodatkowe'
        ParentShowHint = False
        ShowHint = True
        TabOrder = 1
        DesignSize = (
          192
          275)
        object FANN__Epoki_Ilość_Etykieta_Label: TLabel
          Left = 5
          Top = 40
          Width = 48
          Height = 13
          Hint = '<Epochenmenge.>'#13#10#13#10'<Epoch quantity.>'
          Caption = 'Epoki ilo'#347#263
          ParentShowHint = False
          ShowHint = True
        end
        object FANN__Algorytm_Uczący_Etykieta_Label: TLabel
          Left = 5
          Top = 70
          Width = 79
          Height = 13
          Hint = '<Lernalgorithmus.>'#13#10#13#10'<Learning algorithm.>'
          Caption = 'Algorytm ucz'#261'cy'
          ParentShowHint = False
          ShowHint = True
        end
        object FANN__Funkcja_Aktywująca_Warstw_Ukrytych_Etykieta_Label: TLabel
          Left = 5
          Top = 100
          Width = 98
          Height = 26
          Hint = 
            '<Funktion, die versteckte Ebenen aktiviert.>'#13#10#13#10'<Function that a' +
            'ctivates hidden layers.>'
          Caption = 'Funkcja aktywuj'#261'ca warstw ukrytych'
          ParentShowHint = False
          ShowHint = True
          WordWrap = True
        end
        object FANN__Funkcja_Aktywująca_Warstwy_Wyjścia_Etykieta_Label: TLabel
          Left = 5
          Top = 135
          Width = 98
          Height = 26
          Hint = 
            '<Funktion, die Ausgabeschichten aktiviert.>'#13#10#13#10'<Function that ac' +
            'tivates output layers.>'
          Caption = 'Funkcja aktywuj'#261'ca warstwy wyj'#347'cia'
          ParentShowHint = False
          ShowHint = True
          WordWrap = True
        end
        object FANN__Przygotuj_Button: TButton
          Left = 5
          Top = 175
          Width = 75
          Height = 25
          Hint = 
            'FANN przygotuj (tworzy i uczy sie'#263' fann).'#13#10#13#10'<FANN-Vorbereitung ' +
            '(bildet und lehrt ein FANN-Netzwerk).>'#13#10#13#10'<FANN prepare (creates' +
            ' and teaches a FANN network).>'
          Caption = 'F. przygotuj'
          ParentShowHint = False
          ShowHint = True
          TabOrder = 5
          OnClick = FANN__Przygotuj_ButtonClick
        end
        object FANN__Opcje_Dodatkowe__Wysokość_Zmień_Button: TButton
          Left = 165
          Top = 10
          Width = 20
          Height = 20
          Hint = 
            'Opcje dodatkowe zwi'#324' / rozwi'#324'.'#13#10#13#10'<Zus'#228'tzliche Optionen einklapp' +
            'en / erweitern.>'#13#10#13#10'<Additional options collapse / expand.>'
          Anchors = [akTop, akRight]
          Caption = '-'
          ParentShowHint = False
          ShowHint = True
          TabOrder = 0
          OnClick = FANN__Opcje_Dodatkowe__Wysokość_Zmień_ButtonClick
        end
        object FANN__Epoki_SpinEdit: TSpinEdit
          Left = 66
          Top = 40
          Width = 121
          Height = 22
          Hint = 'Epoki ilo'#347#263'.'#13#10#13#10'<Epochenmenge.>'#13#10#13#10'<Epoch quantity.>'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -11
          Font.Name = 'Tahoma'
        ...
        object FANN__Algorytm_Uczący_ComboBox: TComboBox
          Left = 90
          Top = 70
          Width = 100
          Height = 22
          Hint = 'Algorytm ucz'#261'cy.'#13#10#13#10'<Lernalgorithmus.>'#13#10#13#10'<Learning algorithm.>'
        ...
        object FANN__Funkcja_Aktywująca_Warstw_Ukrytych_ComboBox: TComboBox
          Left = 110
          Top = 100
          Width = 150
          Height = 22
          Hint = 
            'Funkcja aktywuj'#261'ca warstw ukrytych.'#13#10#13#10'<Funktion, die versteckte' +
            ' Ebenen aktiviert.>'#13#10#13#10'<Function that activates hidden layers.>'
          Style = csOwnerDrawFixed
          DropDownCount = 30
          ItemIndex = 10
          ParentShowHint = False
        ...
        object FANN__Funkcja_Aktywująca_Warstwy_Wyjścia_ComboBox: TComboBox
          Left = 110
          Top = 140
          Width = 150
          Height = 22
          Hint = 
            'Funkcja aktywuj'#261'ca warstwy wyj'#347'cia.'#13#10#13#10'<Funktion, die Ausgabesch' +
            'ichten aktiviert.>'#13#10#13#10'<Function that activates output layers.>'
          Style = csOwnerDrawFixed
          DropDownCount = 30
          ItemIndex = 0
          ParentShowHint = False
        ...
        object FANN__Zapisz_Button: TButton
          Left = 5
          Top = 240
          Width = 75
          Height = 25
          Hint = 
            'Zapisz przygotowan'#261' sie'#263' fann do pliku.'#13#10#13#10'<Speichern Sie das vo' +
            'rbereitete FANN-Netzwerk in einer Datei.>'#13#10#13#10'<Save the prepared ' +
            'network of FANN to a file.>'
          Caption = 'F. zapisz'
          ParentShowHint = False
          ShowHint = True
          TabOrder = 9
          OnClick = FANN__Zapisz_ButtonClick
        end
        object FANN__Wczytaj_Button: TButton
          Left = 90
          Top = 240
          Width = 75
          Height = 25
          Hint = 
            'Wczytaj sie'#263' fann z pliku.'#13#10#13#10'<Netzwerk-FANN aus Datei laden.>'#13#10 +
            #13#10'<Load network FANN from file.>'
          Caption = 'F. wczytaj'
          ParentShowHint = False
          ShowHint = True
          TabOrder = 10
          OnClick = FANN__Wczytaj_ButtonClick
        end
        object FANN__Plik_Nazwa_ComboBox: TComboBox
          Left = 5
          Top = 210
          Width = 180
          Height = 21
          Hint = 
            'Nazwa pliku sieci.'#13#10#13#10'<Der Name der Netzwerkdatei.>'#13#10#13#10'<The name' +
            ' of the network file.>'
          Anchors = [akLeft, akTop, akRight]
          DropDownCount = 40
          ParentShowHint = False
        ...
        object FANN__Zwolnij_Button: TButton
          Left = 90
          Top = 175
          Width = 35
          Height = 25
          Hint = 
            'FANN zwolnij (zwalnia sie'#263' fann).'#13#10#13#10'<FANN frei (das FANN-Netzwe' +
            'rk freigeben).>'#13#10#13#10'<FANN free (dispose the fan network).>'
          Caption = 'F. zwolnij'
          ParentShowHint = False
          ShowHint = True
          TabOrder = 6
          OnClick = FANN__Zwolnij_ButtonClick
        end
        object Neuronów_W_Warstwach_Ukrytych_Edit: TEdit
          Left = 135
          Top = 175
          Width = 50
          Height = 21
          Hint = 
            'Neuron'#243'w w warstwach ukrytych.'#13#10#13#10'Np.:'#13#10'5, 3'#13#10'dwie warstwy ukryt' +
            'e, pierwsza ma 5 neuron'#243'w, druga 3.'#13#10#13#10#13#10'<Neuronen in verborgene' +
            'n Schichten.'#13#10#13#10'Z.B.:'#13#10'5, 3'#13#10'zwei versteckte Schichten, die erst' +
            'e hat 5 Neuronen, die zweite hat 3.>'#13#10#13#10#13#10'<Neurons in hidden lay' +
            'ers.'#13#10#13#10'E.g.:'#13#10'5, 3'#13#10'two hidden layers, the first has 5 neurons,' +
            ' the second has 3.>'
          Anchors = [akLeft, akTop, akRight]
          ParentShowHint = False
          ShowHint = True
  ...
  object Gra_GLScene: TGLScene
    ...
    object Zero_GLSphere: TGLSphere
      ...
      object GLAtmosphere1: TGLAtmosphere
        Sun = Gra_GLLightSource
        Opacity = 2.000000000000000000
        AtmosphereRadius = 0.600000023841857900
        PlanetRadius = 0.500000000000000000
        LowAtmColor.Color = {0000803F0000003F000000000000803F}
        HighAtmColor.Color = {0000803F0000003F000000000000803F}
      end
      ...
      object GLTorus1: TGLTorus
        ...
        Material.FrontProperties.Diffuse.Color = {0000803F0000003F000000000000003F}
    ...
    object Współrzędne_Test_GLDummyCube: TGLDummyCube
      Pickable = False
      CubeSize = 0.009999999776482582
    end
    object Informacja_GLHUDSprite: TGLHUDSprite
      Material.FrontProperties.Ambient.Color = {0000000000000000000000000000003F}
      ...
      Position.Coordinates = {0000014300009841000000000000803F}
      Visible = False
      Width = 250.000000000000000000
      Height = 30.000000000000000000
      Rotation = 0.000000000000000000
    end
    object Informacja_GLHUDText: TGLHUDText
      Position.Coordinates = {0000704100002041000000000000803F}
      Visible = False
      BitmapFont = Informacja_GLWindowsBitmapFont
      Text = 'abc'
      Rotation = 0.000000000000000000
    end
  end
  ...
  object Informacja_GLWindowsBitmapFont: TGLWindowsBitmapFont
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
    Font.Height = -16
    Font.Name = 'Georgia'
